...
router.post('/pubpic',function(req,res,next){
    var username = req.body.username;
    var imgData = req.body.imgData;
    var fileName = 'user'+ username + method.getNowFormatDate()+'.jpg';
    ...
    fs.writeFile('./public/upload/'+fileName, dataBuffer, function(err) {
        if(err){
          ...
          pool.getConnection(function (err, connection) {
                ...
                var sql = 'insert into publish (username,pubpic) values(\''+username+'\',\''+avatarName+'\')';

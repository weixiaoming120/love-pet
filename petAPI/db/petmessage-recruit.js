...
pool.getConnection(function(err, connection) {
    ...
    PetR.prototype.save = function save(admin,callback) {
        pool.getConnection(function (err, connection) {
            ...
            var insertPetmessage_Sql = "INSERT INTO petmessage(petname,petsex,petkind,petdate) VALUES(?,?,?,?)";

            connection.query(insertPetmessage_Sql, [admin.petname,admin.petsex,admin.petkind,admin.petdate], function (err, result) {
